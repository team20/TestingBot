 ...
 */
public class ChainableDriveCommand3Controllers extends DriveCommand3Controllers {

	/**
	 * The {@code ChainableDriveCommand} right before this
	 * {@code ChainableDriveCommand}.
	 */
	private ChainableDriveCommand3Controllers m_previous;
	 ...
	 */
	public ChainableDriveCommand3Controllers(DriveSubsystem driveSubsystem, Pose2d targetPose, double distanceTolerance,
	 ...
	 * @param angleTolerance the angle error in degrees which is tolerable
	 */
	public ChainableDriveCommand3Controllers(DriveSubsystem driveSubsystem, Supplier<Pose2d> poseSupplier,
	 ...
	 */
	public ChainableDriveCommand3Controllers(DriveSubsystem driveSubsystem, Pose2d targetPose, double distanceTolerance,
			double angleTolerance, ChainableDriveCommand3Controllers previous) {
		this(driveSubsystem, () -> driveSubsystem.getPose(), () -> targetPose, distanceTolerance, angleTolerance,
				previous);
		m_previous = previous;
	}
	...
	public ChainableDriveCommand3Controllers(DriveSubsystem driveSubsystem, Supplier<Pose2d> poseSupplier,
			...
			double angleTolerance, ChainableDriveCommand3Controllers previous) {
		super(driveSubsystem, poseSupplier, targetPoseSupplier, distanceTolerance, angleTolerance,
				previous.m_controllerX, previous.m_controllerY, previous.m_controllerYaw);
		m_previous = previous;
	}
